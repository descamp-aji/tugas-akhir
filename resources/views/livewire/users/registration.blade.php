                    ...
                    <div class="card-body">
                        <form class="row g-3" wire:submit="save">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="password" name="password" wire:model="password" class="form-control" id="password" placeholder="Masukan password">
                            </div>
                            <div class="col-md-12">
                                <label for="password_confirmation" class="form-label">Konfirmasi Password</label>
                                <input type="password" name="password_confirmation" wire:model="password_confirmation" class="form-control" id="password_confirmation" placeholder="Masukan ulang password">
                            </div>
                            @error('password')
                            ...
                            <div class="col-12 text-center">
                                ...
                                <a class="btn btn-regist" href="{{route('dashboard')}}">Batal</a>
                            </div>
